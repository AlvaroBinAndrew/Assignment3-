...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav  ml-auto" style="position: relative; top: -10px;">
      <a class="nav-link active" href="<?php echo e(url('home')); ?>"  style="cursor: pointer;" >HOME <span class="sr-only">(current)</span></a>
      <a class="nav-link" href="<?php echo e(url('blog')); ?>">BLOG</a>
      <a class="nav-link" href="<?php echo e(url('curhat')); ?>">RUANG CURHAT</a>
      <a class="nav-link" href="<?php echo e(url('konseling')); ?>">KONSELING</a>
    </div>  
    </div>
  </div>
</nav>
...
</html><?php /**PATH C:\xampp\htdocs\curcin\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>