...
<div class="card" style="">
  ...
  <div class="card-body">
    ...
    <div class="card" >
      <div class="card-body" >
        <div class="row">
          <div class="col-1"><img src="<?php echo e(asset('img/usericon.png')); ?>" class="img-fluid"></div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\curcin\resources\views/curhat.blade.php ENDPATH**/ ?>